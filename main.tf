...
locals {
  // see https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/rds_cluster#restore_to_point_in_time-argument-reference
...
resource "aws_rds_cluster" "this" {
  ...
  master_password   = var.replicate_from_database ? null : (var.master_password != null ? var.master_password : random_password.master_password[0].result)
